...
def initialize_harness(self: Any, **params: Any) -> None:
    ...
    artifact_summarization_threshold = params.get("artifact_summarization_threshold", 1560)
    ...
    graph_node_timeout_sec = params.get("graph_node_timeout_sec", 300)
    graph_model_call_timeout_sec = params.get("graph_model_call_timeout_sec", 600)
    graph_dispatch_tools_timeout_sec = params.get("graph_dispatch_tools_timeout_sec", 300)
    graph_idle_watchdog_sec = params.get("graph_idle_watchdog_sec", 300)
    graph_recursion_limit = params.get("graph_recursion_limit", 1024)
    graph_coding_recursion_limit = params.get("graph_coding_recursion_limit", 2048)
    needs_human_timeout_sec = params.get("needs_human_timeout_sec", 600)
    ...
    tool_plan_allow_git = params.get("tool_plan_allow_git", False)
    ...
    min_exploration_steps = params.get("min_exploration_steps", 1)
    chunk_mode_min_bytes = params.get("chunk_mode_min_bytes", 4096)
    chunk_mode_new_file_only = params.get("chunk_mode_new_file_only", True)
    chunk_mode_supported_models = params.get("chunk_mode_supported_models", ["qwen3.5", "llama3.1", "deepseek-v3"])
    small_model_soft_write_chars = params.get("small_model_soft_write_chars", 2000)
    small_model_hard_write_chars = params.get("small_model_hard_write_chars", 4000)
    new_file_chunk_mode_line_estimate = params.get("new_file_chunk_mode_line_estimate", 100)
    allow_multi_section_turns_for_small_edits = params.get("allow_multi_section_turns_for_small_edits", True)
    failed_local_patch_limit = params.get("failed_local_patch_limit", 2)
    enable_write_intent_recovery = params.get("enable_write_intent_recovery", True)
    enable_assistant_code_write_recovery = params.get("enable_assistant_code_write_recovery", True)
    write_recovery_min_confidence = params.get("write_recovery_min_confidence", "high")
    write_recovery_allow_raw_text_targets = params.get("write_recovery_allow_raw_text_targets", True)
    solver_refine_enabled = params.get("solver_refine_enabled", False)
    solver_refine_max_passes = params.get("solver_refine_max_passes", 1)
    solver_refine_on_final_answer = params.get("solver_refine_on_final_answer", True)
    solver_refine_on_patch_plan = params.get("solver_refine_on_patch_plan", True)
    solver_refine_on_task_complete = params.get("solver_refine_on_task_complete", True)
    solver_refine_token_budget = params.get("solver_refine_token_budget", 700)
    ...
    self._harness_kwargs = build_harness_kwargs(
        ...
        graph_node_timeout_sec=int(graph_node_timeout_sec),
        graph_model_call_timeout_sec=int(graph_model_call_timeout_sec),
        graph_dispatch_tools_timeout_sec=int(graph_dispatch_tools_timeout_sec),
        graph_idle_watchdog_sec=int(graph_idle_watchdog_sec),
        graph_recursion_limit=int(graph_recursion_limit),
        graph_coding_recursion_limit=int(graph_coding_recursion_limit),
        needs_human_timeout_sec=int(needs_human_timeout_sec),
        fresh_run=fresh_run,
        ...
        artifact_summarization_threshold=int(artifact_summarization_threshold),
        ...
        tool_plan_allow_git=bool(tool_plan_allow_git),
        ...
        min_exploration_steps=int(min_exploration_steps),
        chunk_mode_min_bytes=int(chunk_mode_min_bytes),
        chunk_mode_new_file_only=bool(chunk_mode_new_file_only),
        chunk_mode_supported_models=list(chunk_mode_supported_models or []),
        small_model_soft_write_chars=int(small_model_soft_write_chars),
        small_model_hard_write_chars=int(small_model_hard_write_chars),
        new_file_chunk_mode_line_estimate=int(new_file_chunk_mode_line_estimate),
        allow_multi_section_turns_for_small_edits=bool(allow_multi_section_turns_for_small_edits),
        failed_local_patch_limit=int(failed_local_patch_limit),
        enable_write_intent_recovery=bool(enable_write_intent_recovery),
        enable_assistant_code_write_recovery=bool(enable_assistant_code_write_recovery),
        write_recovery_min_confidence=str(write_recovery_min_confidence or "high"),
        write_recovery_allow_raw_text_targets=bool(write_recovery_allow_raw_text_targets),
        solver_refine_enabled=bool(solver_refine_enabled),
        solver_refine_max_passes=int(solver_refine_max_passes),
        solver_refine_on_final_answer=bool(solver_refine_on_final_answer),
        solver_refine_on_patch_plan=bool(solver_refine_on_patch_plan),
        solver_refine_on_task_complete=bool(solver_refine_on_task_complete),
        solver_refine_token_budget=int(solver_refine_token_budget),
