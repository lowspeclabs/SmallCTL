...
def _env_raw_config(env_or_dotenv: Any) -> dict[str, Any]:
    return {
        ...
        "tool_call_repair_enabled": env_or_dotenv(f"{ENV_PREFIX}TOOL_CALL_REPAIR_ENABLED"),
        "tool_call_repair_log_only": env_or_dotenv(f"{ENV_PREFIX}TOOL_CALL_REPAIR_LOG_ONLY"),
        "tool_call_repair_max_actions_per_call": env_or_dotenv(f"{ENV_PREFIX}TOOL_CALL_REPAIR_MAX_ACTIONS_PER_CALL"),
        ...
        "allow_artifact_read_large_context": env_or_dotenv(f"{ENV_PREFIX}ALLOW_ARTIFACT_READ_LARGE_CONTEXT"),
